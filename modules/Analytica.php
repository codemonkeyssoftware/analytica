...
class Analytica
{
	const CLASSES_PREFIX = "Analytica_";
	...
	{
		if(substr_count($class, Analytica::CLASSES_PREFIX) > 0)
		{
			return $class;
		}
		return Analytica::CLASSES_PREFIX.$class;
	}
	...
	{
		$log = new Analytica_Log;
	}
	static public function createConfigObject()
	{
		$config = new Analytica_Config;
	...
	static public function createTables()
	{
		...
		Analytica::log("Creating ". implode(", ", self::getTablesNames()));
	...
	static public function uninstall()
	{
		...
		Analytica::log("Droping ". implode(", ", self::getTablesNames()));
