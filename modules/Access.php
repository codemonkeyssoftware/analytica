...
class Analytica_Access
{
    ...
    private function loadRoles()
    {
        ...
        if($result->getCode() == Analytica_Access::SUCCESS_SUPERUSER_AUTH_CODE)
        {
            $this->isSuperUser = true;
            $sitesId = Analytica_SitesManager::getAllSitesId();
        ...
        elseif($result->isValid())
        {
            ...
            $rolesRaw = $db->fetchAll("SELECT role, idsite FROM ".Analytica::prefixTable('role').
